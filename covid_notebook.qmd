...
mobility_com_loess <- tsd(mobility_com_ts, method="loess", s.window=366, trend=TRUE)
plot(mobility_com_loess, col=1:4)

mobility_com_spec <- spectrum(extract(mobility_com_loess, components="trend"), spans=c(5,7))
```
...
mobility_com_loess_wd <- tsd(mobw_ts2, method="loess", s.window=366, trend=TRUE)
plot(mobility_com_loess_wd, col=1:4)
mobility_com_spec_wd <- spectrum(extract(mobility_com_loess_wd, components="trend"), spans=c(5,7))
```
...
mobw_ts <- ts(mobw$alimentation_pharmacies, start = c(2020, 46), frequency = 365)
plot(mobw_ts)
mobw_ts2 <- aggregate(mobw_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
plot(mobw_ts2)
```
...
mobw_ts <- ts(mobw$parcs, start = c(2020, 46), frequency = 365)
plot(mobw_ts)
mobw_ts2 <- aggregate(mobw_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
plot(mobw_ts2)
```
...
mobility_transport_loess <- tsd(mobility_transport_ts, method="loess", s.window=13, trend=TRUE)
plot(mobility_transport_loess, col=1:4)
...
mobw_ts <- ts(mobw$arrets_transports, start = c(2020, 46), frequency = 365)
plot(mobw_ts)
mobw_ts2 <- aggregate(mobw_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
plot(mobw_ts2)
```
